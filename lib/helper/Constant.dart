...
String appname='Davistar Mata';
///package name of your app
String androidPackage='com.davistar.media';
///ios bundle name
...
///api url
String base_url='http://blender-eevee.download/Api/';
...
Color primary=Color(0xFFAC0000);
///secondary color of your app
Color secondary=Color(0xFF2E0077);

Color tertiary=Color(0xFFFFFFFF);

Color apptextcolor=Color(0xFFFFFFFF);
